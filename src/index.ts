...
async function activate(context: ExtensionContext): Promise<void> {
	context.subscriptions.push(
		...
		commands.registerTextEditorCommand(
			"extension.applescript.compileBundle",
			async () => {
		...
		commands.registerTextEditorCommand(
			"extension.applescript.compileApp",
			async () => {
		...
		commands.registerTextEditorCommand(
			"extension.applescript.createBuildTask",
			async () => {
		...
		commands.registerTextEditorCommand(
			"extension.applescript.terminateProcess",
			async () => {
				await pick();
			},
		),
		...
		commands.registerTextEditorCommand(
			"extension.jxa.terminateProcess",
			async () => {
				await pick();
			},
		),
